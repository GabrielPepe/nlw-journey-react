            ...
            <div className="bg-zinc-900 w-[640px] py-5 px-6 shadow-shape rounded-xl space-y-5">
              ...
              <form onSubmit={createTrip} className="space-y-3">
                <div className="h-14 px-4 bg-zinc-950 border-zinc-800 rounded-lg flex items-center gap-2">
                  ...
                  <input name="name" className="outline-none bg-transparent flex-1" placeholder="Seu nome completo" onChange={event => setOwnerName(event.target.value)}/>
                </div>
                <div className="h-14 px-4 bg-zinc-950 border-zinc-800 rounded-lg flex items-center gap-2">
                  <User className="text-zinc-400 size-5"/>
                  <input type="email" name="email" className="outline-none bg-transparent flex-1" placeholder="Seu e-mail pessoal" onChange={event => setOwnerEmail(event.target.value)}/>
                </div>
                <Button type='submit' >
